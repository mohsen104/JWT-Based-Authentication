...
import { accessTokenGenerator, generateCodeOtp, loginMethod, refreshTokenGenerator, responseFormatter } from '../../common/utils/functions.js';
...
const UserService = {
    ...
    loginOtp: async (userDto) => {
        ...
        res.cookie("refresh_token", refreshTokenGenerator(user), {
            httpOnly: true,
            secure: true,
